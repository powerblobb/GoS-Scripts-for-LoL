...
--self.MonTourMenu.Misc:Slider("MGUNSIZE", "Kill Text Size", 17, 10, 21, 1)
----self.MonTourMenu.Misc:ColorPick("CTSCKS", "Current Target Color", {255,255,0,0})
--self.MonTourMenu.Misc:Slider("MGUNX", "Kill X POS", 753, 0, 1700, 1)
--self.MonTourMenu.Misc:Slider("MGUNY", "Kill Y POS", 809, 0, 1100, 1)
...
----end
--DrawText("Q gametime: "..self.gametimeQ,20,200,200,0xff00ff00);
--DrawText("Q gametime Ready: "..self.gametimeQ+Q3,20,200,220,0xff00ff00);
--if self.gametimeQ+Q3-GetGameTimer() > 0 then
--DrawText("ONCOOLDOWN Q: "..self.gametimeQ+Q3-GetGameTimer(),20,200,240,0xff00ff00);
--else
--DrawText("READY Q: Yes",20,200,240,0xff00ff00);
--end

--DrawText("R gametime: "..self.gametimeR,20,200,260,0xff00ff00);
--DrawText("R gametime Ready: "..self.gametimeR+R3,20,200,280,0xff00ff00);
--if self.gametimeR+R3-GetGameTimer() > 0 then
--DrawText("ONCOOLDOWN R: "..self.gametimeR+R3-GetGameTimer(),20,200,300,0xff00ff00);
--else
--DrawText("READY R: Yes",20,200,300,0xff00ff00);
--end

--DrawText("E gametime: "..self.gametimeE,20,200,320,0xff00ff00);
--DrawText("E gametime Ready: "..self.gametimeE+E3,20,200,340,0xff00ff00);
--if self.gametimeE+E3-GetGameTimer() > 0 then
--DrawText("ONCOOLDOWN E: "..self.gametimeE+E3-GetGameTimer(),20,200,360,0xff00ff00);
--else
--DrawText("READY R: Yes",20,200,360,0xff00ff00);
--end

--DrawText("W gametime: "..self.gametimeW,20,200,380,0xff00ff00);
--DrawText("W gametime Ready: "..self.gametimeW+W3,20,200,400,0xff00ff00);
--if self.gametimeW+W3-GetGameTimer() > 0 then
--DrawText("ONCOOLDOWN W: "..self.gametimeW+W3-GetGameTimer(),20,200,420,0xff00ff00);
--else
...
--end
MoT2:NoteEnemys(false,self.OverAllDmgAnivia,0,0,0,0,0,0,0,0)
MoT2:NoteAllys()
end
...
function Anivia:GLOBALULTNOTICE()
local herocounter = 0
local killable = ""
for hero,unit in pairs(GetEnemyHeroes()) do
local percent=math.floor(GetCurrentHP(unit)/GetMaxHP(unit)*100)
local DMGpercent=math.floor(self.OverAllDmgAnivia/GetCurrentHP(unit)*100)
...
DrawDmgOverHpBar(unit,enemyhp,0,self.OverAllDmgAnivia,ARGB(255, 255, 255, 255)) 
end
end
end
...
local Rdmg =  (40 + 40*GetCastLevel(myHero,_R)+0.25*GetBonusAP(myHero))*1.5 --80 / 120 / 160 (+ 25% AP)
for i,unit in pairs(GetEnemyHeroes()) do 
local enemyhp = GetCurrentHP(unit) + GetHPRegen(unit) + GetMagicShield(unit) + GetDmgShield(unit)
...
--      DrawCircle(wPos2.x,wPos2.y,wPos2.z,6,6,100,0xffff0000)
--      DrawCircle(wPos3.x,wPos3.y,wPos3.z,6,6,100,0xffff0000)
----      DrawLine(wPos.x-200,wPos.y,wPos.x+200,wPos.y,1,ARGB(255,255,255,255))
--elseif GetCastLevel(myHero,_W) == 2 then   
--      DrawCircle(wPos.x,wPos.y,wPos.z,20,20,100,0xffff0000)
--      DrawCircle(wPos.x+250,wPos.y,wPos.z,20,20,100,0xffff0000)
--      DrawCircle(wPos.x-250,wPos.y,wPos.z,20,20,100,0xffff0000)
--elseif GetCastLevel(myHero,_W) == 3 then   
--      DrawCircle(wPos.x,wPos.y,wPos.z,20,20,100,0xffff0000)
--      DrawCircle(wPos.x+300,wPos.y,wPos.z,20,20,100,0xffff0000)
--      DrawCircle(wPos.x-300,wPos.y,wPos.z,20,20,100,0xffff0000)      
--elseif GetCastLevel(myHero,_W) == 4 then   
--      DrawCircle(wPos.x,wPos.y,wPos.z,20,20,100,0xffff0000)
--      DrawCircle(wPos.x+350,wPos.y,wPos.z,20,20,100,0xffff0000)
--      DrawCircle(wPos.x-350,wPos.y,wPos.z,20,20,100,0xffff0000)     
--elseif GetCastLevel(myHero,_W) == 5 then   
--      DrawCircle(wPos.x,wPos.y,wPos.z,20,20,100,0xffff0000)
--      DrawCircle(wPos.x+400,wPos.y,wPos.z,20,20,100,0xffff0000)
--      DrawCircle(wPos.x-400,wPos.y,wPos.z,20,20,100,0xffff0000)        
--end
end
end
...
self.MonTourMenu:Slider("MGUNY", "Kill Y POS", 809, 0, 1080, 1)
...
self.MonTourMenu:Slider("MGUNSIZE2", "Kill Text Size", 17, 10, 21, 1)
self.MonTourMenu:Slider("MGUNX2", "Kill X POS", 1639, 0, 1920, 1)
self.MonTourMenu:Slider("MGUNY2", "Kill Y POS", 564, 0, 1080, 1)
